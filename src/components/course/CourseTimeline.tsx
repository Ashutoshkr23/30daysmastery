                        ...
                        <Link href={isLocked ? "#" : `/courses/${course.id}/day/${day.dayNumber}`}>
                            <GlassCard
                                ...
                                className={cn(
                                    ...
                                    !isLocked && !isCompleted && "border-primary/20 ring-1 ring-primary/5"
                                )}
                            >
                                <div className="flex items-start justify-between gap-4">
                                    <div className="space-y-1">
                                        <h3 className={cn("font-semibold text-lg leading-tight", isCompleted && "text-muted-foreground line-through decoration-primary/50")}>
                                            {day.title}
                                        </h3>
                                    ...
                                    {isCompleted && (
                                        <span className="shrink-0 rounded-full bg-green-500/10 dark:bg-green-500/20 px-2.5 py-0.5 text-[10px] font-bold uppercase tracking-wider text-green-600 dark:text-green-400 border border-green-200 dark:border-green-800">
                                            Done
                                        </span>
                                    )}
                                </div>
